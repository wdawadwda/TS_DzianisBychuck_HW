...
// Task 4
//___________________________________________________________________________________
const subjectArray: { subject: string; students: number; teachers: number }[] = Object.entries(subjects).map(([subject, {students, teachers}]) => (
  {subject,students,teachers}
  ));
console.log(subjectArray);

const subjectsArray2: { subject: string; students: number; teachers: number }[] = Object.entries(subjects).map(([subject, data]) => ({subject, ...data}));
console.log(subjectsArray2);

// Task 5
//___________________________________________________________________________________
const sortedSubjects: { subject: string; students: number; teachers: number }[] = Object.entries(subjects)
